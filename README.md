...
`HECKLE` 会观察当前前台应用、窗口标题和近期切换轨迹，在窗口切换、长时间停留或手动触发时，让大模型生成一句贴合当前行为的屑萌小恶魔雌小鬼式吐槽。

视觉名称写作 **HΞCKLE**。中间的 `Ξ` 像一张抿着嘴、满脸无语的表情——正准备评价你刚才那一下。也可以想象成小萝莉皱眉（？）

它不是效率助手，也不会劝你自律。它只负责坐在旁边说风凉话。`(￣へ￣)`

> `(¬Ξ¬)` 写了十分钟就溜去搜 Python 问题，不会吧不会吧～

## 😈 吐槽人格

HECKLE 不是纯粹骂人，而是那种早就看穿你、还故意明知故问的二次元小恶魔：

- 攻击性 `5/10`，得意感 `8/10`
- 喜欢抓包、坏笑、假装同情和欠欠的反问
- 偶尔出现“不会吧不会吧～”“这就不行啦？”“真拿你没办法呢♡”
- 可能吐槽“杂鱼操作♡”，但不会直接贬低或羞辱用户本人
- 每次只说一句，点到为止，不提供建议，也不进行效率说教
